...
output:
  html:
    ...
    css: syllabus.css
  pdf: 
    output-file: "demog280-social-networks-fall2025.pdf"
#output:
#  html_document: 
...
<!--
NOTE: to get links to the URLs where the papers can be downloaded, you might
have to go into the Zotero settings -> Better BiBTex -> Oppen Better BibTeX preferences -> Export
... and then in the 'Add URLs to BibTeX export' pulldown, select "in the 'url' field"
-->
...
<!--
Maybe apicella et al?
or something other than the grinberg one?
-->
...
For an overview of networks topics that is focused on Sociology, the Rawlings
et al book is also a good reference:

* [@rawlings_network_2023]
...
I'll share a video that derives some properties of random graph models; if you want extra background,
the Newman chapter (which the video is based on) is a good reference:
...
* Hoff et al paper, which we will read in a coming week
* [@mccormick_how_2010]
* [@mccormick_latent_2012]
* [@handcock_modeling_2010]
* [@hoff_bilinear_2005]
* [@baum_explaining_2025]

Hidden populations:  
    
* (Scale-up) [@feehan_network_2017] 
* (Scale-up) [@laga_correlated_2023]
* (Scale-up) [@laga_estimating_2025]
* (RDS) [@crawford_hidden_2018]
* (RDS) [@roch_generalized_2018]
* (RDS) [@baraff_estimating_2016]
...
* Good excerpts/comments on several classics can be found here: [@small_personal_2021]
* [@white_social_1976]
* [@portes_social_2000]
...
* a relevant [Facebook research note](https://research.facebook.com/blog/2016/2/three-and-a-half-degrees-of-separation/)
...
### `r next_week()` - Project check-in {#sec:projectpitch}
...
### `r next_week()` - Structure, segregation, and communities {#sec:communities}
...
**The reading is not too long this week. Please take the opportunity to work on your project,
and to catch up on your extra paper presentations!**

* [@christakis_social_2010]
* [@helleringer_sexual_2007]
* [@zapperi_epidemiology_2025]
...
### `r next_week()` - Complex contagion and social influence part I {#sec:complex-contagion}
...
### `r next_week()` - Social influence II {#sec:influence}
...
### `r next_week()` Collaboration and cooperation {#sec:cooperation}

*Note: the readings for this week are especially likely to change; this is
a placeholder for this topic...*
...
### `r next_week()` - Thanksgiving (no class)
